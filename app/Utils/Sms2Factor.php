...
class Sms2Factor
{
    ...
    public static function sendOTP(string $phone, string $templateName = 'Simple OTP')
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://2factor.in/API/V1/" . Config::get('constant.2factor.api_key', '') . "/SMS/$phone/AUTOGEN/$templateName",
    ...
    public static function verifyOTP(string $sessionID, string $otp)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://2factor.in/API/V1/" . Config::get('constant.2factor.api_key', '') . "/SMS/VERIFY/$sessionID/$otp",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
    ...
    public static function sendRegistrationSuccessMsg(string $gatePassNumber, string $phone) {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://2factor.in/API/V1/". Config::get('constant.2factor.api_key', '') ."/ADDON_SERVICES/SEND/TSMS",
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_ENCODING => "",
            CURLOPT_MAXREDIRS => 10,
            CURLOPT_TIMEOUT => 30,
