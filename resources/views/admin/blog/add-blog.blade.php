...
@section('body')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <form action="{{ url('blog?action=add-blog') }}" id="blogform" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="card col-md-6">
                                    <div class="card-body">
                                        ...
                                        <div id='img_contain'><img id="blah" align='middle'
                                                src="{{ asset('assets/default-image.png') }}" alt="your image"
                                                title='' />
                                        </div>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" id="inputGroupFile01" name="image"
                                                    ...
                                                    aria-describedby="inputGroupFileAddon01" accept="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 px-5">
                                    ...
                                    <label for="link" class="form-label mt-3">Categories <span class="text-danger">
                                            *</span></label>
                                    <br>
