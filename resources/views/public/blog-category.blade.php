...
@section('body')
    ...
    <section class="u-clearfix u-image u-shading u-csection-1" id="sec-60a4" data-image-width="1280" data-image-height="627"
                                                ...
                                                <div class="post-item position-relative h-100">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        @if (strlen(html_entity_decode(strip_tags($data->title))) >= 1)
                                                            <h6 class="post-title text-dark" style="min-height: 40px">
                                                            ...
                                                            @foreach ($allblog as $data)
                                                                @if ($data->is_published == 1)
                                                                    <div class="post-item mt-3">
                                                                        ...
                                                                        <div>
                                                                            <h4>
                                                                                    <a href="{{ url('blog-details', ['slug' => $data->slug]) }}" class=""> {{ substr(strip_tags($data->title), 0, 43) }}......
                                                                                    </a>
                                                                            </h4>
