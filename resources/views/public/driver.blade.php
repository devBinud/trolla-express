...
@section('title', 'Services | Driver')
@section('meta-description', '')
@section('meta-keywords', '')
@section('ogtitle', '')
@section('meta-og-description', '')
@section('url', 'https://www.trollaexpress.com/page?action=driver')
@section('image', '')

@section('custom-css')
    <link rel="stylesheet" href="{{ asset('assets/public/css/Services.css') }}">
    <style>
        .driver__paragraph-top{
            margin: 30px 20px;
            background:#fff;
            border-radius:10px;
            padding:23px;
        ...
        .driver__paragraph-top h3{
            padding:20px 0;
            text-align:center
        }
        .driver__img-description{
            padding:30px 0;
        }
        .driver__img-description .driver__img-description-box .driver__img img{
            width:50%
        }
        .driver__content__boxes{
            margin-top: 30px;
        }
        .driver__content__box{
            display: flex;
            align-items: center;
            text-align: center;
 ...
 <section class="u-clearfix u-image u-shading u-section-1" id="sec-60a4" data-image-width="1280" data-image-height="627"
     style="background-image:linear-gradient(0deg, rgba(0,0,0,0.6), rgba(0,0,0,0.45)), url('{{ asset('assets/public/images/transporter.jpg') }}');">
        <div class="u-clearfix u-sheet u-sheet-1">
            <h1 class="u-custom-font u-text u-text-default u-text-1">DRIVER SERVICE</h1>
            <h6 class="u-custom-font u-text u- u-text-default u-text-2">Features We Provide </h6>

            <div class="container">
                <div class="driver__paragraph-top">
    ...
    <div class="driver__img-description">
     <div class="container">
         <div class="driver__img-description-box">
            <div class="row">
                <div class="col-md-6">
                  <div class="driver__img">
                    <img class="img-fluid" src="{{asset('assets/public/images/driver-screenshot.png')}}" alt="">
                  </div>
                </div>
                <div class="col-md-6">
                    <div class="driver__content__boxes">
                        <h4>Features that provided</h4>
                        <p class="text-secondary">
                        The objective is to improve income and costs for driver/truck owners while decreasing operational costs and delivery times for shippers. Customers (Shipper, Transporter/Truck Owner) will have access to this Trolla market place that connects empty load truckers with suppliers in need of deliveries via an annual membership.
                        </p>
                       <div class="row">
                        <div class="col-md-6 col-6 mt-2">
                            <div class="driver__content__box">
    ...
    <section class="u-black u-clearfix u-section-3" id="sec-91ee">
        <div class="u-clearfix u-sheet u-sheet-1">
            <a href="https://play.google.com/store/apps/details?id=com.trolla.seal.driver" target="_blank">
